...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer ignoringCustomizer() {
        return (web) -> {
            ...
            Optional.ofNullable(prop.getExclude().getWebPaths())
                ...
                .ifPresent(list -> ignoring.antMatchers(list.toArray(new String[0])));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        Optional.ofNullable(prop.getExclude().getWebPaths())
            .map(list -> list.isEmpty() ? null : list)
            .ifPresent(list -> requests.antMatchers(list.toArray(new String[0])).permitAll());
        ...
        Optional.ofNullable(prop.getExclude().getApiPaths())
            ...
            .forEach(e -> {
                ...
                requests.antMatchers(method, e.get(0)).permitAll();
            });
